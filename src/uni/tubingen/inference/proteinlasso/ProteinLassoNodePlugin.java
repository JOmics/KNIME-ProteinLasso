 ...
 * @author enrique
 */
public class ProteinLassoNodePlugin extends Plugin {
    // The shared instance.
    private static ProteinLassoNodePlugin plugin;

    /**
     * The constructor.
     */
    public ProteinLassoNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ProteinLassoNodePlugin getDefault() {
        return plugin;
    }
